...
export default function Weather() {
    return (
        <div className="Weather">
            ...
            <h1>Odesa</h1>
            <ul>
                <li>Last updated: Sunday 16:20</li>
                <li>Mostly Cloudy</li>
            </ul>    
            </div>
